...
const translations = {
  en: {
    ...
    heroSub: "Modern houses for a new generation. Thoughtfully designed, sustainably built, and attainable.",
    ...
    val4Title: "Family First", val4Desc: "Designed for the way modern families actually live.",
    featTag: "Key Features",
    featTitle: "Designed for Modern Living",
    feat1Title: "Floor-to-Ceiling Windows", feat1Desc: "Premium metal-clad windows with triple glazing flood every room with natural daylight.",
    ...
    feat5Title: "Security Entrance", feat5Desc: "Premium security entrance door with modern locking technology.",
    feat6Title: "Photovoltaic Ready", feat6Desc: "Prepared for solar panel installation from day one.",
    ...
    showList1c: "Floor-to-ceiling windows for maximum daylight",
    showList1d: "Smart-home ready infrastructure",
    showTag2: "Bathrooms",
    showTitle2: "Premium Bathrooms,<br>Everyday Luxury",
    showSub2: "Thoughtfully designed bathroom spaces with high-quality fixtures and finishes.",
    ...
    faq1A: "Instead of an expensive basement, we provide practical storage rooms exactly where families need them — at the entrance, near the carport, and within the house. This keeps costs transparent and living efficient.",
  ...
  de: {
    ...
    heroSub: "Moderne Häuser für eine neue Generation. Durchdacht geplant, nachhaltig gebaut und erreichbar.",
    ...
    val4Title: "Familie Zuerst", val4Desc: "Gestaltet für den Alltag moderner Familien.",
    featTag: "Ausstattung",
    ...
    feat5Title: "Sicherheits­eingang", feat5Desc: "Premium Sicherheitstür mit moderner Schliesstechnik.",
    feat6Title: "Photovoltaik Ready", feat6Desc: "Vorbereitet für die Installation von Solarmodulen.",
    showTag1: "Wohnräume",
    ...
    showTag2: "Badezimmer",
    showTitle2: "Premium Badezimmer,<br>Alltäglicher Luxus",
    showSub2: "Durchdacht gestaltete Badezimmer mit hochwertigen Armaturen und Oberflächen.",
    ...
    faq1A: "Anstelle eines teuren Kellers bieten wir praktische Abstellräume genau dort, wo Familien sie brauchen — beim Eingang, am Carport und im Haus. Das hält die Kosten transparent.",
